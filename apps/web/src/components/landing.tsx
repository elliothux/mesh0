...
export function Landing({
  ...
  return (
    <main className="site-shell">
      <Hero isAuthenticated={isAuthenticated} loginUrl={loginUrl} />
...
function Hero({
  ...
  const appHref = isAuthenticated ? "/dashboard" : loginUrl;
  const appLabel = isAuthenticated ? "Dashboard" : "Sign In";
  ...
  return (
    <header className="hero" id="top">
      ...
      <nav aria-label="Main navigation" className="nav">
        ...
        <a className="nav-github" href={appHref}>
          {appLabel}
  ...
  return (
    <section aria-label="Control plane model" className="feature-intro">
      ...
      <div className="control-strip">
        <span>{apiStatusCount} status rows</span>
